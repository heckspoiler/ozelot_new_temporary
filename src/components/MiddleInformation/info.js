export const information = [
  {
    id: 1,
    title: 'About Ozelot',
    description: `Ozelot Studio is a mixed media studio, with a mission to create future ideas, immersive and relevant brand experiences. We are constantly looking for creative processes that elevates a brand’s identity in the digital and physical realm.`,
    lottieLink:
